...
abstract class DependencyParsingTransitionSystem(
  ...
  val annotatedSentence: AnnotatedSentence = {
    ...
    val tokenFeatureTagger = new TokenFeatureTagger(Seq(
      ...
      TokenPropertyFeature('depLabelFreqSmall),
      TokenPropertyFeature('depLabelFreqBelow1),
      TokenPropertyFeature('depLabelFreq1to10),
      TokenPropertyFeature('depLabelFreq11to20),
      TokenPropertyFeature('depLabelFreq21to30),
      TokenPropertyFeature('depLabelFreq31to40),
      TokenPropertyFeature('depLabelFreq41to50),
      TokenPropertyFeature('depLabelFreq51to60),
      TokenPropertyFeature('depLabelFreq61to70),
      TokenPropertyFeature('depLabelFreq71to80),
      TokenPropertyFeature('depLabelFreq81to90),
      TokenPropertyFeature('depLabelFreq91to100),
      TokenPropertyFeature('postagFreqSmall),
      TokenPropertyFeature('postagFreqBelow1),
      TokenPropertyFeature('postagFreq1to10),
      TokenPropertyFeature('postagFreq11to20),
      TokenPropertyFeature('postagFreq21to30),
      TokenPropertyFeature('postagFreq31to40),
      TokenPropertyFeature('postagFreq41to50),
      TokenPropertyFeature('postagFreq51to60),
      TokenPropertyFeature('postagFreq61to70),
      TokenPropertyFeature('postagFreq71to80),
      TokenPropertyFeature('postagFreq81to90),
      TokenPropertyFeature('postagFreq91to100),
