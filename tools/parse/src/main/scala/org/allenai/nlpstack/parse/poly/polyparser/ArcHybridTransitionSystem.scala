  ...
  def constructDefaultFeature(keywords: Set[Symbol]): StateFeature = {
    val features = List(
      ...
      new TokenCardinalityFeature(Seq(StackRef(0), StackRef(1), StackRef(2),
        ...
        StackGretelsRef(0), StackGretelsRef(1), BufferGretelsRef(0),
        StackLeftGretelsRef(0), StackRightGretelsRef(0))),
      new OfflineBinaryTokenFeature(StackRef(1), StackRef(0)),
      new OfflineBinaryTokenFeature(StackRef(0), BufferRef(0)),
      new OfflineBinaryTokenFeature(BufferRef(0), BufferRef(1)),
      new OfflineBinaryTokenFeature(StackRef(1), BufferRef(0)),
      new OfflineBinaryTokenFeature(StackRef(0), BufferRef(1)),
      new OfflineBinaryTokenFeature(StackRef(0), StackGretelsRef(0)),
      //new OfflineTernaryTokenFeature(StackRef(1), StackRef(0), BufferRef(0)),
