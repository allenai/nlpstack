...
class OmnibusTrainer()
  ...
  val dtTrainer = new RandomForestTrainer(0, 20, 0.1, EntropyGainMetric(0), numThreads = 6)
  val rfTrainer = new RandomForestTrainer(0, 20, 0.1, EntropyGainMetric(0), numThreads = 6)
