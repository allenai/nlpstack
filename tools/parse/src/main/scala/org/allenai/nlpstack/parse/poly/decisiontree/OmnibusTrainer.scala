...
class OmnibusTrainer()
  ...
  val dtTrainer = new RandomForestTrainer(0, 12, 0.1f, EntropyGainMetric(0), numThreads = 6)
  val rfTrainer = new RandomForestTrainer(0, 12, 0.1f, EntropyGainMetric(0), numThreads = 6)
