...
import org.allenai.nlpstack.coref.defaultCorefResolver
...
object Impl {
  ...
  private[tools] val dependencyParser = new PolytreeParser
  private[tools] val coref = defaultCorefResolver
